...
test_files = glob.glob('/media/robotixx/SSD_Data2/Aniket/DL747_Project/code2/3_with_4x/train_test_ours/demo_imgs/*.ARW') 
...
checkpoint = torch.load('/media/robotixx/SSD_Data2/Aniket/DL747_Project/code2/3_with_4x/train_test_ours/weights/weights_10000', map_location=device)
