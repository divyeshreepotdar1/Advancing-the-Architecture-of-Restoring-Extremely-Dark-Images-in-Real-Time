...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv32x = nn.Sequential(        
                        conv_layer(1024, 128, kernel_size=3, groups=64, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True),
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.conv64x = nn.Sequential(
            conv_layer(4096, 128, kernel_size=3, groups=64, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True),
            conv_layer(128, 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        )
        self.conv32x = nn.Sequential(
            conv_layer(1024, 128, kernel_size=3, groups=64, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True),
        ...
        self.conv16x = nn.Sequential(
            conv_layer(256, 128, kernel_size=3, groups=64, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True),
            conv_layer(128, 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        )

        self.conv4x = nn.Sequential(
            conv_layer(64, 128, kernel_size=3, groups=64, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True),
            conv_layer(128, 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        )


        self.RDB1 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB2 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB3 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB4 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB5 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB6 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB7 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB8 = RDB(nChannels=64, nDenselayer=5, growthRate=32)
        self.RDB9 = RDB(nChannels=64, nDenselayer=5, growthRate=32)

        self.rdball1 = conv_layer(int(64 * 2), 64, kernel_size=1, groups=1, bias=False, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.rdball2 = conv_layer(int(64 * 2), 64, kernel_size=1, groups=1, bias=False, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.rdball3 = conv_layer(int(64 * 2), 64, kernel_size=1, groups=1, bias=False, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.rdball4 = conv_layer(int(64 * 2), 64, kernel_size=1, groups=1, bias=False, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)


        self.conv_rdb8x0 = conv_layer(1, 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.conv_rdb8x1 = conv_layer(int(64 // 16), 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.conv_rdb8x2 = conv_layer(int(64 // 4), 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.conv_rdb8x3 = conv_layer(int(64), 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        
        self.conv_rdb8x4 = conv_layer(int(64 * 3), 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.conv_rdb8x5 = conv_layer(int(64 * 3), 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        self.conv_rdb8x6 = conv_layer(int(64 * 2), 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
    ...
    def forward(self, low):
        ...
        rdb1 = self.RDB1(low32x_beforeRDB)
        rdb2 = self.RDB2(rdb1)
        rdb8x1 = torch.cat((rdb1, rdb2), dim=1)
        rdb8x1 = self.rdball2(rdb8x1) + low32x_beforeRDB
        rdb8x1 = self.up4(rdb8x1)
        rdb8x1 = self.conv_rdb8x1(rdb8x1)

        
        # 16x branch starts
        low16x_beforeRDB = self.conv16x(self.downshuffle(low2x, 8))
        rdb3 = self.RDB3(low16x_beforeRDB)
        rdb4 = self.RDB4(rdb3)
        rdb8x2 = torch.cat((rdb3, rdb4), dim=1)
        rdb8x2 = self.rdball3(rdb8x2) + low16x_beforeRDB
        rdb8x2 = self.up2(rdb8x2)
        rdb8x2 = self.conv_rdb8x2(rdb8x2)
        
         # 4x branch starts
        low4x_beforeRDB = self.downshuffle(low2x, 4)
        low4x_beforeRDB = self.conv4x(low4x_beforeRDB)
        rdb5 = self.RDB5(low4x_beforeRDB)
        rdb6 = self.RDB6(rdb5)
        rdb8x3 = torch.cat((rdb5, rdb6), dim=1)
        rdb8x3 = self.rdball4(rdb8x3) + low4x_beforeRDB
        rdb8x3 = self.conv_rdb8x3(rdb8x3)

        rdb8x4 = self.RDB7(rdb8x1)
        rdb8x5 = self.RDB8(rdb8x2)
        rdb8x6 = self.RDB9(rdb8x3)

        rdb8x7 = torch.cat((rdb8x4, rdb8x5, rdb8x6), dim=1)
        rdb8x7 = self.conv_rdb8x4(rdb8x7)

        rdb8x8 = torch.cat((rdb8x1, rdb8x2, rdb8x3), dim=1)
        rdb8x8 = self.conv_rdb8x5(rdb8x8)

        rdb8x = torch.cat((rdb8x7, rdb8x8), dim=1)
        rdb8x = self.conv_rdb8x6(rdb8x)
