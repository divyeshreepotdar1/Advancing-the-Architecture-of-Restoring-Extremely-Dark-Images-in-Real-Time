...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.conv16x = nn.Sequential(
            conv_layer(256, 128, kernel_size=3, groups=128, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True),
            conv_layer(128, 64, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization=True)
        )
    ...
    def forward(self, low):
        ...
        rdb4 = self.RDB4(low16x_beforeRDB)
        ...
        rdb8x = torch.cat((rdb8x1, rdb8x2), dim=1)
