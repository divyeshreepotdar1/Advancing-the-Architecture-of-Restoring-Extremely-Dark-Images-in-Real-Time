...
opt['batch_size'] = 32
opt['atWhichSave'] = [2,1000, 2000, 3000, 5000, 8000, 10000, 20000, 100000, 150002,200000,250002,300002,350002,400002,450002,500002,550000, 600000,650002,700002,750000,800000,850002,900002,950000,1000000] # testing will be done at these iterations and corresponding model weights will be saved.
opt['iterations'] = 100001 # The model will run for these many iterations.
