...
test_files = glob.glob('/media/robotixx/SSD_Data2/Aniket/DL747_Project/code2/Restoring-Extremely-Dark-Images-In-Real-Time/train_test_ours/demo_imgs/*.ARW') 
...
checkpoint = torch.load('/media/robotixx/SSD_Data2/Aniket/DL747_Project/code2/Restoring-Extremely-Dark-Images-In-Real-Time/train_test_ours/weights/weights_20000', map_location=device)
